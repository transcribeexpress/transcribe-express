...
export const HOME_ANSWER_FIRST: AnswerFirstContent = {
  ...
  link: {
    href: "/guide-transcription#audio-vers-texte",
    label: "Lire le guide vérifié de la transcription",
  },
};
...
export const PRICING_ANSWER_FIRST: AnswerFirstContent = {
  ...
  link: {
    href: "/guide-transcription#tarif-transcription",
    label: "Comprendre les coûts et les usages",
  },
};
...
export const DEMO_ANSWER_FIRST: AnswerFirstContent = {
  ...
  link: {
    href: "/guide-transcription#precision-transcription",
    label: "Comprendre la précision et ses limites",
  },
};
